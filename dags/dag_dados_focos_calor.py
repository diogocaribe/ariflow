    ...
    for file_info in extracted_files:
        ...
        try:
            ...
            insert_query = f"""
                ...
                VALUES %s
                ON CONFLICT (lat, lon, data_pas) DO NOTHING;
            """
...
create_table_task = PostgresOperator(
    ...
    sql=f"""
        ...
        CREATE TABLE IF NOT EXISTS {TABLE_NAME} (
            ...
            CONSTRAINT unique_lat_long_data_pas UNIQUE (lat, lon, data_pas)
        );
        
        CREATE INDEX IF NOT EXISTS idx_queimadas_data_hora ON {TABLE_NAME}(data_pas);
        CREATE INDEX IF NOT EXISTS idx_queimadas_municipio ON {TABLE_NAME}(municipio);
    """,
    dag=dag,
)
